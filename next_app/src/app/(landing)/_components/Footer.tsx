      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div className="col-span-1">
            <h3 className="mb-4 text-xl font-bold text-white">Commitly</h3>
            <p className="mb-4">
          ...
          <div className="col-span-1 flex flex-col items-center">
            <h4 className="mb-4 mr-[10px] font-semibold text-white">
              Quick Links
            </h4>
          ...
          {/* Legal */}
          {/* <div className="col-span-1 flex flex-col items-center">
            <h4 className="mb-4 mr-[80px] text-left font-semibold text-white">
              Legal
            </h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-neutral-800 pt-8 text-center">
          <p>
            &copy; {new Date().getFullYear()} Commitly. All rights reserved.
          </p>
